...
export default function Cart() {
  ...
  return (
    <View style ={{flex:1 }}>
      ...
      <View style={{fontSize:20, flexDirection:"row",justifyContent:'center', alignItems:'center'}}><Text >Cart List</Text></View>
      </View>
      ...
      <Text style ={{color:"rgb(222, 212, 221)",}}>(3 items)</Text>
